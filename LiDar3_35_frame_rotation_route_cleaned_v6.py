...
def main():
    ...
    try:
        while True:
            ...
            for e in pygame.event.get():
                ...
                if e.type == pygame.KEYDOWN:
                    ...
                    if e.key == pygame.K_q:
                        ...
                        print(f"[POSE] Offset visual: {pose_view_yaw_offset_deg:+.1f}°")
            ...
            yaw_deg_draw  = yaw_deg_real + pose_view_yaw_offset_deg
            yaw_deg       = yaw_deg_real
            ...
            if (now - last_render_time) >= INTERVALO_DIBUJO:
                ...
                # J/K rotan SOLO la pose visual y los conos.
