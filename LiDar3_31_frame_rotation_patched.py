...
# ═══════════════════════════════════════════════════════
POSE_VIEW_FINE_DEG    =  1.0   # Q/E ajustan la pose/nube ±1°
POSE_VIEW_COARSE_DEG  = 10.0   # Shift+Q ajusta -10° (Shift+E reservado al relé)
        ...
        while True:
            ...
            for e in pygame.event.get():
                ...
                if e.type == pygame.KEYDOWN:
                    ...
                    if e.key == pygame.K_q:
                        step = POSE_VIEW_COARSE_DEG if _shift_held else POSE_VIEW_FINE_DEG
                        pose_view_yaw_offset_deg = (pose_view_yaw_offset_deg - step) % 360.0
                        if pose_view_yaw_offset_deg > 180:
                            pose_view_yaw_offset_deg -= 360
                        print(f"[POSE] Offset angular: {pose_view_yaw_offset_deg:+.1f}°")
                        ...
                        pose_view_yaw_offset_deg = (pose_view_yaw_offset_deg + POSE_VIEW_FINE_DEG) % 360.0
                        if pose_view_yaw_offset_deg > 180:
                            pose_view_yaw_offset_deg -= 360
                        print(f"[POSE] Offset angular: {pose_view_yaw_offset_deg:+.1f}°")
                        ...
                        pose_view_yaw_offset_deg = 0.0
                        print("[POSE] Offset angular reset a 0°")
            ...
            yaw_deg   = saved_yaw_offset + arduino.get_yaw() + pose_view_yaw_offset_deg
            ...
            if modo == MODE_SCAN:
                ...
                if fsm_state == FSM_BACKUP:
                    if rear_blocked:
                        ...
                        # Distancia recorrida en reversa usando solo la pose LiDAR actual.
            ...
            auto_aux_enable = bool(clean_sys and comp_on and cam_aux_pwm > 0)
            ...
            if (now - last_render_time) >= INTERVALO_DIBUJO:
                ...
                state = {
                    ...
                    "view_rotation_deg":  pose_view_yaw_offset_deg,
