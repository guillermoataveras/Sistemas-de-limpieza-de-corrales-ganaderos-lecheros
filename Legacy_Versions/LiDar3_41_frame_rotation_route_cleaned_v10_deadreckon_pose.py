...
def main():
    ...
    try:
        while True:
            ...
            yaw_deg_motion   = yaw_deg_base + frame_rotation_deg
            yaw_deg_motion = yaw_deg_motion + BODY_FRAME_OFFSET_DEG + body_pose_yaw_offset_deg
            ...
            lidar_hits_global = transform_scan_to_global(
                ang, dist, lidar_x_mm, lidar_y_mm, yaw_deg_motion
            )
