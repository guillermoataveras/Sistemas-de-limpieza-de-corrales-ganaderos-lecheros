...
def main():
    ...
    mission_home_set = (saved_doc is not None and
                        abs(mission_home_x - LIDAR_X_INICIAL_MM) > 10)
        ...
        while True:
            ...
            if modo == MODE_SCAN:
                ...
                if fsm_state == FSM_BACKUP:
                    if rear_blocked:
                        ...
                        enc_i, enc_d, enc_avail = arduino.get_encoder_deltas()
                        if enc_avail:
                            d_step = abs((enc_i + enc_d) * 0.5 * MM_PER_DEG_WHEEL)
            ...
            if wall_centers_xy is not None:
                ...
                if match_tick_counter >= MATCH_EVERY_N_TICKS:
                    ...
                    # Se compara la posición antes/después de cada pasada,
                    # no la corrección absoluta acumulada.
                    ...
                    for _icp in range(ICP_ITERATIONS):
                        ...
                        # Convergencia: el desplazamiento en esta iteración
                    ...
                    last_pose_correction = math.hypot(
                        lidar_x_mm - _icp_x, lidar_y_mm - _icp_y
                    ) if _icp > 0 else last_match_corr_mm
            ...
            if (now - last_render_time) >= INTERVALO_DIBUJO:
                ...
                state = {
                    ...
                    "pose_source_label":  (
                        "MATCH+ENC" if (wall_centers_xy is not None and enc_available)
