...
def main():
    ...
    cam_dirt_ema   = 0.0          # suciedad filtrada con EMA (0=limpio, 1=sucio)
    cam_tile_label = CAM_LABEL_CLEAN
    cam_white_ratio= 1.0
    cam_dirt_ratio = 0.0
    cam_aux_pwm    = 0            # PWM auxiliar decidido por visión
    cam_roi_corners= []           # esquinas del ROI en coordenadas globales
