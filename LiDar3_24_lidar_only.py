...
def replan_cleaning(grid_map, paso_mm=None):
    ...
    if not wps:
        # Si el filtro eliminó todos, intentar con margen reducido
    ...
    # Cuando dos waypoints consecutivos tienen un obstáculo/pared en
    # línea recta, A* inserta puntos intermedios que rodean la pared.
                ...
                if rear_frame is not None:
                    ...
                    if (cam_rear_dirt_ratio > CAM_REAR_DIRT_FEEDBACK_THR
                        ...
                        if n_reset > 0:
                            ...
                            # Reducir paso adaptativo si hay resuciado frecuente
